...
(* OASIS_START *)
(* DO NOT EDIT (digest: d9792148dfe9dc59a43d1791b4f67366) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Tcpip_stack_socket"; "Ipv4_socket"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "tcpip";
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "o\211\221\210m_e`/\214\236\"\247\026\000\174";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
