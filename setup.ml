...
(* OASIS_START *)
(* DO NOT EDIT (digest: 4fe4975dfc095f8114679d98b642c4ca) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = ["checksum_stubs_xen.c"];
                      bs_data_files = [];
                      bs_ccopt =
                        [(OASISExpr.EBool true, ["-O2"; "${XEN_CFLAGS}"])];
                      bs_cclib = [(OASISExpr.EBool true, [])];
                      bs_dlllib = [(OASISExpr.EBool true, [])];
                      bs_dllpath = [(OASISExpr.EBool true, [])];
                      bs_byteopt = [(OASISExpr.EBool true, [])];
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Ipv4"; "Arpv4"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "tcpip";
                      lib_findlib_name = Some "ipv4";
                      lib_findlib_containers = []
                   });
               Library
                 ({
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Dhcpv4_option"; "Dhcp_clientv4"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "tcpip";
                      lib_findlib_name = Some "dhcpv4";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "tcpip-stack-direct";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("cstruct", None);
                           FindlibPackage ("lwt", None);
                           InternalLibrary "ethif";
                           InternalLibrary "udp";
                           InternalLibrary "tcp";
                           InternalLibrary "dhcpv4"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                   ...
                   {
                      lib_modules = ["Tcpip_stack_direct"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "tcpip";
                      lib_findlib_name = Some "stack-direct";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "ethif";
                           FindlibPackage ("mirage-net-unix", None);
                           FindlibPackage ("lwt", None);
                   ...
                   {
                      lib_modules = ["Ethif_unix"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "tcpip";
                      lib_findlib_name = Some "ethif-unix";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Ipv4_unix"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "tcpip";
                      lib_findlib_name = Some "ipv4-unix";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Ipv6_unix"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "tcpip";
                      lib_findlib_name = Some "ipv6-unix";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "udp";
                           InternalLibrary "ipv4-unix";
                           FindlibPackage ("lwt", None);
                           FindlibPackage ("lwt.unix", None);
                           FindlibPackage ("ipaddr.unix", None);
                   ...
                   {
                      lib_modules = ["Udpv4_unix"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "tcpip";
                      lib_findlib_name = Some "udpv4-unix";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Udpv6_unix"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "tcpip";
                      lib_findlib_name = Some "udpv6-unix";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "udpv4-socket";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      lib_modules = ["Udpv4_socket"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "tcpip";
                      lib_findlib_name = Some "udpv4-socket";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "udpv6-socket";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      lib_modules = ["Udpv6_socket"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "tcpip";
                      lib_findlib_name = Some "udpv6-socket";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "tcp";
                           InternalLibrary "ipv4-unix";
                           InternalLibrary "channel";
                           FindlibPackage ("lwt", None);
                           FindlibPackage ("lwt.unix", None);
                           FindlibPackage ("mirage-unix", None);
                   ...
                   {
                      lib_modules = ["Tcpv4_unix"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "tcpip";
                      lib_findlib_name = Some "tcpv4-unix";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Tcpv6_unix"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "tcpip";
                      lib_findlib_name = Some "tcpv6-unix";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "tcpv4-socket";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      lib_modules = ["Tcpv4_socket"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "tcpip";
                      lib_findlib_name = Some "tcpv4-socket";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "tcpv6-socket";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      lib_modules = ["Tcpv6_socket"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "tcpip";
                      lib_findlib_name = Some "tcpv6-socket";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "tcpip-stack-unix";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "udpv4-unix";
                           InternalLibrary "tcpv4-unix";
                           InternalLibrary "udpv6-unix";
                           InternalLibrary "tcpv6-unix";
                           InternalLibrary "tcpip-stack-direct";
                           FindlibPackage ("lwt", None);
                           FindlibPackage ("lwt.unix", None);
                           FindlibPackage ("ipaddr.unix", None);
                           FindlibPackage ("mirage-unix", None);
                   ...
                   {
                      lib_modules = ["Tcpip_stack_unix"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "tcpip";
                      lib_findlib_name = Some "stack-unix";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "tcpip-stack-socket";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "udpv4-socket";
                           InternalLibrary "udpv6-socket";
                           InternalLibrary "tcpv4-socket";
                           InternalLibrary "tcpv6-socket";
                           FindlibPackage ("lwt", None);
                           FindlibPackage ("lwt.unix", None);
                           FindlibPackage ("ipaddr.unix", None);
                           FindlibPackage ("io-page.unix", None)
                   ...
                   {
                      lib_modules =
                        ["Tcpip_stack_socket"; "Ipv4_socket"; "Ipv6_socket"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "tcpip";
                      lib_findlib_name = Some "stack-socket";
                      lib_findlib_containers = []
                   });
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("io-page.unix", None);
                           InternalLibrary "channel";
                           FindlibPackage ("mirage-profile.unix", None);
                           FindlibPackage ("mirage-flow", None);
                           FindlibPackage ("mirage-vnetif", None);
                           FindlibPackage ("mirage-console.unix", None);
                           InternalLibrary "ethif";
                           InternalLibrary "tcp";
                           FindlibPackage ("pcap-format", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\230$D\165\148\198\015\250\n`\184\251\137\157\164J";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
